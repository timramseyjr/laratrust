...
.. NOTE::
    If you plan on using the Levels hierarchical functionality, you will need to add the optional trait to your user model that is outlined in the :ref:`user`.
